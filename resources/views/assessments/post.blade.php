					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<select name="student" class="form-control student-change">
									@foreach ($teacher->students as $student)
										@if ($student->post_assessment == 0)
							...
							<div class="form-group">
								<label>How many NBA Math Hoops games have you played this year?</label>
								<select name="games_completed" class="form-control student-change">
									<option value="1" selected>0</option>
									<option value="2">1-5</option>
									<option value="3">6-10</option>
									<option value="4">11-29</option>
									<option value="5">30+</option>
								</select>
							</div>
							
							<div class="form-group">
								<label>How many NBA Math Hoops "basketball skills" pieces have you completed this year?</label>
								<select name="skills_pieces" class="form-control student-change dont-tab">
									<option value="1" selected>0</option>
							...
							@else
							<div class="form-group">
								<label>How many Athletics Math Hits games have you played this year?</label>
								<select name="games_completed" class="form-control student-change">
									<option value="1" selected>0</option>
									<option value="2">1-5</option>
									<option value="3">6-10</option>
							...
							<div class="form-group">
								<label>How many Athletics Math Hits skills pieces have you completed this year?</label>
								<select name="skills_pieces" class="form-control student-change dont-tab">
									<option value="1" selected>0</option>
									<option value="2">1-3</option>
									<option value="3">4-6</option>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="survey-options">
												<div class="radio-inline">
													<input type="radio" name="work_well_with_others" value="1" /> Never
												</div>
												<div class="radio-inline">
													<input type="radio" name="work_well_with_others" value="2" checked /> Sometimes
												</div>
												<div class="radio-inline">
													<input type="radio" name="work_well_with_others" value="3" /> Most of the Time
												</div>
												<div class="radio-inline">
													<input type="radio" name="work_well_with_others" value="4" /> Always
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<p>I enjoy playing NBA Math Hoops games.</p>
										</td>
										<td>
											<div class="survey-options">
												<div class="radio-inline">
													<input type="radio" name="math_hoops_games" value="1" /> Strongly Disagree
												</div>
												<div class="radio-inline">
													<input type="radio" name="math_hoops_games" value="2" /> Disagree
												</div>
												<div class="radio-inline">
													<input type="radio" name="math_hoops_games" value="3" checked /> Neutral
												</div>
												<div class="radio-inline">
													<input type="radio" name="math_hoops_games" value="4" /> Agree
												</div>
												<div class="radio-inline">
													<input type="radio" name="math_hoops_games" value="5" /> Strongly Agree
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<p>I enjoy learning from the NBA Math Hoops worksheets.</p>
										</td>
										<td>
											<div class="survey-options">
												<div class="radio-inline">
													<input type="radio" name="worksheets" value="1" /> Strongly Disagree
												</div>
												<div class="radio-inline">
													<input type="radio" name="worksheets" value="2" /> Disagree
												</div>
												<div class="radio-inline">
													<input type="radio" name="worksheets" value="3" checked /> Neutral
												</div>
												<div class="radio-inline">
													<input type="radio" name="worksheets" value="4" /> Agree
												</div>
												<div class="radio-inline">
													<input type="radio" name="worksheets" value="5" /> Strongly Agree
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<p>NBA Math Hoops makes math more fun.</p>
										</td>
										<td>
											<div class="survey-options">
												<div class="radio-inline">
													<input type="radio" name="math_more_fun" value="1" /> Strongly Disagree
												</div>
												<div class="radio-inline">
													<input type="radio" name="math_more_fun" value="2" /> Disagree
												</div>
												<div class="radio-inline">
													<input type="radio" name="math_more_fun" value="3" checked /> Neutral
												</div>
												<div class="radio-inline">
													<input type="radio" name="math_more_fun" value="4" /> Agree
												</div>
												<div class="radio-inline">
													<input type="radio" name="math_more_fun" value="5" /> Strongly Agree
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<p>I feel more confident in math class after participating in NBA Math Hoops.</p>
										</td>
										<td>
											<div class="survey-options">
												<div class="radio-inline">
													<input type="radio" name="confident_after" class="dont-tab" value="1" /> Strongly Disagree
												</div>
												<div class="radio-inline">
													<input type="radio" name="confident_after" class="dont-tab" value="2" /> Disagree
												</div>
												<div class="radio-inline">
													<input type="radio" name="confident_after" class="dont-tab" value="3" checked /> Neutral
												</div>
												<div class="radio-inline">
													<input type="radio" name="confident_after" class="dont-tab" value="4" /> Agree
												</div>
												<div class="radio-inline">
													<input type="radio" name="confident_after" class="dont-tab" value="5" /> Strongly Agree
												</div>
											</div>
										</td>
									</tr>
