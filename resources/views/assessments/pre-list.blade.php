...
<div class="container">
	<div class="page-header">
		...
		<a href="/admin/preassessment-results/archive" class="btn btn-success btn-sm loader">Archive Results</a>
	</div>
	<div class="row">
		<div class="col-sm-12">
				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr>
							...
							<td>
								<?php $t = \App\Preassessment::where("9/2","=","5")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
							...
							<td>
								<?php $t = \App\Preassessment::where("5/2","=","3")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
							...
							<td>
								<?php $t = \App\Preassessment::where("10/3","=","3")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
							...
							<td>
								<?php $t = \App\Preassessment::where("stay_calm","=","3")->orWhere("stay_calm","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("help_others","=","3")->orWhere("help_others","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("doing_things","=","3")->orWhere("doing_things","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("solving_problems","=","3")->orWhere("solving_problems","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("do_not_give_up","=","3")->orWhere("do_not_give_up","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("give_compliments","=","3")->orWhere("give_compliments","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("do_the_right_thing","=","3")->orWhere("do_the_right_thing","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("making_decisions","=","3")->orWhere("making_decisions","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("think_before_i_act","=","3")->orWhere("think_before_i_act","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("leader","=","3")->orWhere("leader","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("respect","=","3")->orWhere("respect","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("good_decisions","=","3")->orWhere("good_decisions","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("honest_person","=","3")->orWhere("honest_person","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("importance_of_learning","=","3")->orWhere("importance_of_learning","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("think_about_problems","=","3")->orWhere("think_about_problems","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("responsible_person","=","3")->orWhere("responsible_person","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("work_through_problems","=","3")->orWhere("work_through_problems","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("set_goals","=","3")->orWhere("set_goals","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("overcome_a_challenge","=","3")->orWhere("overcome_a_challenge","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("work_well_with_others","=","3")->orWhere("work_well_with_others","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("half_of_value","=","3")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("decimal_numbers_represent","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("nfl_kicker","=","3")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("free_throws","=","5")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("wnba_free_throws","=","2")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("same_shots","=","3")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("odds_of_three_point","=","3")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
							<td>
								<?php $t = \App\Preassessment::where("shot_odds","=","4")->count(); ?>
								{{ ($t > 0) ? (number_format(($t / $total) * 100, 2) . "%") : "0%" }}
							</td>
						</tr>
					</tbody>
