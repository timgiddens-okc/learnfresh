    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Register For A Demo</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/register">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">First and Last Name <span class="required">*</span></label>
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">Phone Number <span class="required">*</span></label>
                        ...
                        <div class="form-group{{ $errors->has('school_program_name') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">School/Program Name <span class="required">*</span></label>
                        ...
                        <div class="form-group{{ $errors->has('site_address_1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="site_address_1" value="{{ old('site_address_1') }}" required>
                         ...
                         <div class="form-group{{ $errors->has('site_address_2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="site_address_2" value="{{ old('site_address_2') }}">
                        ...
                        <div class="form-group{{ $errors->has('site_city') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="site_city" value="{{ old('site_city') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('site_state') ? ' has-error' : '' }}">
                            <label for="site_state" class="col-md-4 control-label">State <span class="required">*</span></label>
                        ...
                        <div class="form-group{{ $errors->has('site_zip_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="site_zip_code" value="{{ old('site_zip_code') }}" required>
