...
<div class="container">
	<div class="page-header">
		...
		<a href="/admin/download-orders" class="btn btn-success btn-sm">Download Spreadsheet</a>
		<a href="/admin/orders/past" class="btn btn-success btn-sm">View Past Orders</a>
	</div>
	<div class="sort">
		<h5>Search Orders:</h5>
		<div class="row">
