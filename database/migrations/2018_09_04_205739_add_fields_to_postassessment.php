...
class AddFieldsToPostassessment extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('postassessments', function (Blueprint $table) {
          ...
          $table->string('math_hoops_games')->nullable();
          $table->string('worksheets')->nullable();
          $table->string('math_more_fun')->nullable();
          $table->string('confident_after')->nullable();
    ...
    public function down()
    {
        Schema::table('postassessments', function (Blueprint $table) {
          ...
          $table->dropColumn('confident_after');
